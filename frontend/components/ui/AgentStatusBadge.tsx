        ...
        <div className="border border-border bg-bg-surface p-6 rounded-none flex flex-col gap-4">
            <div className="flex justify-between items-start">
                ...
                {score !== undefined && (
                    <div className="text-right">
                        <span className="block text-xs tracking-widest text-text-muted uppercase mb-1">SCORE</span>
            ...
            {detail && (
                <div className="pt-4 border-t border-border mt-auto">
                    <p className="text-xs text-text-muted truncate" title={detail}>{detail}</p>
                </div>
            )}
        </div>
    );
